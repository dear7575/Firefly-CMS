...
INSERT INTO `site_settings` VALUES ('50521eb4-5fc3-466a-a590-504597df55c3', 'site_url', 'https://dear7575.cn', 'string', 'basic', '站点URL', '网站的完整URL地址', 98, '2025-12-26 02:02:09');
...
INSERT INTO `site_settings` VALUES ('839f4bd8-e2e9-48fd-9029-61646c2f8625', 'site_description', 'Firefly CMS 是基于 Firefly 主题的二次开发项目，在保留原有精美前端的基础上，新增了完整的后台管理系统，实现了从静态博客到动态内容管理系统的升级，让您能够轻松打造出专业且美观的个人博客网站。', 'text', 'basic', '站点描述', '用于SEO的网站描述', 97, '2025-12-26 02:02:09');
