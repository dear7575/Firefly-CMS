...
export const ru: Translation = {
	...
	[Key.adminBackupManagement]: "Резервная копия",
	[Key.adminManageBackups]: "Экспорт и импорт данных сайта",
	[Key.adminBackupExportAll]: "Экспортировать всё",
	[Key.adminBackupExportPosts]: "Экспортировать посты",
	[Key.adminBackupImport]: "Импортировать резервную копию",
	[Key.adminBackupImportHint]:
		"Импорт JSON резервной копии. Можно выбрать объединение или перезапись.",
	[Key.adminBackupSelectFile]: "Выбрать файл",
	[Key.adminBackupMerge]: "Объединить",
	[Key.adminBackupMergeDesc]: "Сохранить существующие данные и добавить недостающие",
	[Key.adminBackupOverwrite]: "Перезаписать",
	[Key.adminBackupImporting]: "Импорт...",
	[Key.adminBackupImportSuccess]: "Импорт завершён",
	[Key.adminBackupImportFailed]: "Ошибка импорта",
	[Key.adminBackupDownloadFailed]: "Не удалось скачать файл",
	[Key.adminBackupNoFile]: "Сначала выберите файл резервной копии",
	[Key.adminBackupSummary]: "Итоги импорта",
	[Key.adminBackupExportHint]: "Экспортировать все данные или только посты",
	[Key.adminBackupFileEmpty]: "Файл не выбран",
	[Key.adminBackupImportConfirmMerge]: "Объединить импорт этой резервной копии?",
	[Key.adminBackupImportConfirmOverwrite]:
		"Перезаписать импорт этой резервной копии? Данные могут быть заменены.",
	[Key.adminBackupStatImported]: "Импортировано",
	[Key.adminBackupStatSkipped]: "Пропущено",
	[Key.adminBackupStatErrors]: "Ошибки",
	[Key.adminInitSettings]: "Инициализировать настройки",
