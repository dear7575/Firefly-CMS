...
export const ru: Translation = {
	...
	[Key.adminScheduledManagement]: "Публикация по расписанию",
	...
	[Key.adminBackupHistory]: "История резервных копий",
	[Key.adminBackupHistoryHint]: "Просмотр ручных и автоматических резервных копий",
	[Key.adminBackupHistoryRefresh]: "Обновить",
	[Key.adminBackupHistoryLoading]: "Загрузка...",
	[Key.adminBackupHistoryEmpty]: "Записей нет",
	[Key.adminBackupHistoryLoadFailed]: "Не удалось загрузить историю",
	[Key.adminBackupHistoryDownload]: "Скачать",
	[Key.adminBackupHistoryDelete]: "Удалить",
	[Key.adminBackupHistoryDeleteConfirm]: "Удалить эту резервную копию и файл?",
	[Key.adminBackupHistoryDeleteSuccess]: "Запись удалена",
	[Key.adminBackupHistoryDeleteFailed]: "Удаление не удалось",
	[Key.adminBackupHistoryType]: "Тип",
	[Key.adminBackupHistoryTypeFull]: "Полная копия",
	[Key.adminBackupHistoryTypePosts]: "Только посты",
	[Key.adminBackupHistorySource]: "Источник",
	[Key.adminBackupHistorySourceAuto]: "Авто",
	[Key.adminBackupHistorySourceManual]: "Ручной",
	[Key.adminBackupHistorySize]: "Размер",
	[Key.adminBackupHistoryTime]: "Время",
